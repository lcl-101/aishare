...
class GradioBackend:
    ...
    def __init__(self, model_path: str = 'checkpoints/LiveCC-7B-Instruct'):
...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            gr_clean_button.click(
                fn=lambda _: [[], *gr_chatinterface_chatbot_clear_fn(_)],
                inputs=[gr_dynamic_trigger],
                outputs=[gr_video_state, gr_state, gr_static_trigger, gr_dynamic_trigger]
            )
