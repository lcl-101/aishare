...
# pre-trained weights
ip_adapter_path = "checkpoints/InstantCharacter/instantcharacter_ip-adapter.bin"
base_model = 'checkpoints/FLUX.1-dev'
image_encoder_path = 'checkpoints/siglip-so400m-patch14-384'
image_encoder_2_path = 'checkpoints/dinov2-giant'
birefnet_path = 'checkpoints/BiRefNet'
makoto_style_lora_path = "checkpoints/FLUX.1-dev-LoRA-Makoto-Shinkai/Makoto_Shinkai_style.safetensors"
ghibli_style_lora_path = "checkpoints/FLUX.1-dev-LoRA-Ghibli/ghibli_style.safetensors"

# init InstantCharacter pipeline
pipe = InstantCharacterFluxPipeline.from_pretrained(base_model, torch_dtype=torch.bfloat16)
# pipe.to(device)  # 已使用 device_map="balanced"，移除此行
...
def get_example():
    ...
    case = [
        [
            "/home/softice/InstantCharacter/assets/girl.jpg",
            "A girl is playing a guitar in street",
            0.9,
            'Makoto Shinkai style',
        ],
        [
            "/home/softice/InstantCharacter/assets/boy.jpg",
    ...
    with gr.Tabs():
        with gr.Row():
            with gr.Column():
                ...
                with gr.Row():
                    with gr.Column():
                        image_pil = gr.Image(label="Source Image", type='pil')  # 恢复 type='pil'
