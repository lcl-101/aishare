...
EXAMPLE_ITEMS = [
	[
		"The Hunyuan-MT model supports dozens of language directions with strong accuracy across news, tech, and daily scenarios.",
		"Chinese",
		256,
	],
	[
		"随着全球气候变化，越来越多的城市在探索绿色能源的长期解决方案。",
		"English",
		256,
	],
	[
		"请将明天下午三点的项目进度会改到线上进行。",
		"Japanese",
		192,
	],
	[
		"La colaboración entre universidades y empresas impulsa la innovación en inteligencia artificial.",
		"Chinese",
		256,
	],
]
...
with gr.Blocks(title="Hunyuan-MT Multi-language Translation Demo") as demo:
	...
	gr.Examples(
		...
		inputs=[src_input, tgt_lang, max_new],
		outputs=output_box,
		fn=translate,
...
if __name__ == "__main__":
	load_model()  # Preload model so the first UI request is fast
