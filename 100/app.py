...
#model_global_path = snapshot_download(repo_id="checkpoints/Cobra", cache_dir='./Cobra/', repo_type="model")
model_global_path = "checkpoints/Cobra"
if not os.path.exists(model_global_path):
    os.makedirs(model_global_path)
    print("Downloading model...")
    model_global_path = snapshot_download(repo_id="checkpoints/Cobra", cache_dir=model_global_path, repo_type="model")
    print("Model downloaded to:", model_global_path)
...
def load_ckpt():
    ...
    # seed = 43
    lora_rank = 128
    pretrained_model_name_or_path = "checkpoints/PixArt-XL-2-1024-MS"
