...
class Generator:
    def __init__(self):
        ...
        self.bg_rm_model.loadcheckpoints('checkpoints/BEN2/BEN2_Base.pth')
        ...
        # load dreamo
        model_root = 'checkpoints/FLUX.1-dev'
        dreamo_pipeline = DreamOPipeline.from_pretrained(model_root, torch_dtype=torch.bfloat16, quantize_type="int4")
